...
//     var stay = false;
    ...
    function drawCard(hand){
        ...
        var playerOne = new User(playerhand,playerTotal,"Matt");
        var dealer = new User(dealerhand,dealerTotal,"Mcgiblets");
        ...
        $("#hit-but").on("click",function(){hitMe(playerOne.hand,playerOne.total,playerOne.name,playerDiv,dealer.total)});
        $("#stay-but").on("click",function(){handWeight(playerOne.hand,playerOne.total,playerOne.name,dealer.total),disableButton(),endGame(dealer.total,playerOne.total,true,dealer.hand,dealer.name)});
        playerOne.total = handWeight(playerOne.hand,playerOne.total,playerOne.name,dealer.total);
        dealer.total = handWeight(dealer.hand,dealer.total,dealer.name,player.Total);
        ...
        function disableButton(){
            ...
            function endGame(dealerTotal,playerTotal,stay,hand,name){
                ...
                $("#replay-but").on("click",function(){cleanse(),init()});
            }
